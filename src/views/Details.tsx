        ...
        <div className="header-container">
          ...
          <ul className="header-social">
            <li id="facebook" className="header-li">
              <a className="header-a" href="https://facebook.com">
                <img
                  className="header-social-img"
            ...
            <li id="instagram" className="header-li">
              <a className="header-a" href="https://instagram.com">
                <img
                  className="header-social-img"
            ...
            <li id="cart" className="header-li">
              <a className="header-a" href="./cart.html">
                <img
                  className="header-social-img"
        ...
        <div className="details-container">
          <div id="details" className="columns-container">
            ...
            <div className="product-description-block">
              <h1 className="product-title">MacBook Pro 13'4</h1>
              <form className="product-selector">
                <fieldset className="product-fieldset">
                  <label className="product-label" htmlFor="color">
                    Color
                  </label>
                  <select
